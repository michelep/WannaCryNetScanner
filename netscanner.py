...
#
# Originally written by nixawk based on auxiliary/scanner/smb/smb_ms17_010 Metasploit module
# Modified by Michele <o-zone> Pinassi, adding nmap support to scan all hosts in defined network
#
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2:
        print("{} <ip or net>".format(sys.argv[0]))
        sys.exit(1)
    else:
	nm = nmap.PortScanner() # instantiate nmap.PortScanner object
	nm.scan(sys.argv[1], '445') # scan host defined as first arguments, port 445 only
